...
public class TaxonTest {
	...
	public void testTaxon() throws JSONException {
		...
		JSONObject taxonJasonObject=new JSONObject("{"+
				                                   ...
				                                   "}");
		Taxon taxon1 = new TaxonFactory().createTaxon(taxonJasonObject);
	...
	public void testEquals() throws JSONException {
		...
		JSONObject taxonJasonObject2=new JSONObject("{"+
                                                    ...
                                                    "\"plastIdGeneticCode\": \"11\""+
				                                    "}");
		Taxon taxon1 = new TaxonFactory().createTaxon(taxonJasonObject1);
		Taxon taxon2 = new TaxonFactory().createTaxon(taxonJasonObject2);
		...
		JSONObject taxonJasonObject3=new JSONObject("{"+
                                                    ...
                                                    "\"plastIdGeneticCode\": \"11\""+
				                                    "}");
		assertFalse(taxon1.equals(new TaxonFactory().createTaxon(taxonJasonObject3)));
	...
	public void testToString() throws JSONException {
		...
		assertNotNull(new TaxonFactory().createTaxon(taxonJasonObject2).toString());
	}
