...
public class TaxonFactory
{
	...
	public Taxon createTaxon(JSONObject jsonTaxonObject) throws JSONException
	{
		...
		if (jsonTaxonObject != null)
		{
			...
			taxon.setFormalName(jsonTaxonObject.has("formalName") ? jsonTaxonObject.getBoolean("formalName") : false);
			...
			taxon.setSubmittable(jsonTaxonObject.has("submittable") ? jsonTaxonObject.getBoolean("submittable") : false);
		}
		return taxon;
	}
}
